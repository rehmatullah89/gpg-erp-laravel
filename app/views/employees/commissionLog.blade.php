...
@if (isset($errors) && ($errors->any()))
 ...
 {{ Form::open(array('before' => 'csrf' ,'action' => 'EmployeeController@employeeCommissionList', 'files'=>true, 'method' => 'post', 'id' => 'customer_filters_form')) }}
                    ...
                    <?php 
                     ...
                     <tr>
                        ...
                        <td data-title="Commission">&nbsp;
                            <?php echo 'Sales:<strong>'.number_format($data['sales_commission'],2)."%</strong><br>&nbsp;&nbsp;Estimator:<strong>".number_format($data['estimate_commission'],2)."%</strong><br>&nbsp;&nbsp;Contract:<strong>".number_format($data['contract_sales_commission'],2)."%</strong>";  ?><?php if ($data['cur']=='current' && $curFlag==0)  echo "&nbsp;<strong>[Current]</strong>" ?></td>
                        <td data-title="Start Date">&nbsp;
                            <?php  if (!empty($data['start_date'])) echo date("m/d/Y",strtotime($data['start_date'])); 
                                ?></td>
                        <td align="center" nowrap="nowrap">
                            <a href="{{URL::route('employees/deleteWageCommission', array('id'=>$data['id']))}}" onclick="javascript:return(confirm('Are you source, you want to DELETE this?'))">Delete</a>
                        </td>
                    </tr>
