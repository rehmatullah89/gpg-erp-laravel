...
<?php //header('Content-Type: application/pdf'); ?>
          ...
          <div class="row">
             ...
             <span class="tools pull-right">
              ...
              <section class="panel">
                <header class="panel-heading" style="background: white !important;  border-color: solid grey; color:grey;">
                 ...
                 {{ Form::open(array('before' => 'csrf' ,'url'=>route('salestracking/index_quote_phase'), 'files'=>true, 'method' => 'post')) }}
            ...
            <div class="col-sm-12">
               <!-- ////////////////////////////////////////// -->
              <div class="panel">
              <a name="create_st_row" data-toggle="modal" class="btn btn-danger btn-xs" href="#myModal5">Create New Quote in Sales Tracking</i></a>
              <div class="adv-table">
                  ...
                  <table class="table table-bordered table-striped table-condensed cf">
                      ...
                      <tbody>
                        ...
                        @foreach($query_data as $getSalesRow)
                              ...
                              <?php
                                ...
                                switch ($getSalesRow['type_of_sale']) {
                                    case 'PMcontract':
                                        ...
                                        {{ HTML::link('job/job_electrical_quote_frm/'.$qouteNumPtr['0'].'/'.$qouteNumPtr['1'].'',$qouteNumPtr['1'], array('target'=>'_blank','class'=>'btn btn-link btn-xs'))}} 
                                        <?php
                                        }else
                                          echo "-";
                                        break;
                                    case 'ServiceQuote':
                                       ...
                                       if(isset($quoteNum)){ ?>
                                        {{ HTML::link('job/job_electrical_quote_frm/'.$quoteID.'/'. $quoteNum.'', $quoteNum, array('target'=>'_blank','class'=>'btn btn-link btn-xs'))}} 
                                        <?php
                                        }else
                                          echo "-";
                                        break;
                                    ...
                                    case 'Generators':
                                        ...
                                        {{ HTML::link('job/job_electrical_quote_frm/'.$quoteID_arr.'/'.$quoteNum_arr.'',$quoteNum_arr, array('target'=>'_blank','class'=>'btn btn-link btn-xs'))}} 
                                        <?php
                                        }else
                                          echo "-";
                                        break;
                          ...
                          <td>{{(isset($getSalesRow['location']) && !empty($getSalesRow['location']))?$getSalesRow['location']:'-'}}</td>
               ...
               <!-- Modal#3 -->
                        ...
                        <!-- Modal#5 -->
                          <div class="modal fade" id="myModal5" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                {{ Form::open(array('before' => 'csrf' ,'url'=>route('salestracking/createQSTModal'), 'files'=>true,'id'=>'create_rst', 'method' => 'post')) }}
                                  <div class="modal-dialog">
                                      <div class="modal-content">
                                          <div class="modal-header">
                                            {{Form::button('&times;', array('class' => 'close','data-dismiss'=>'modal', 'aria-hidden'=>'true'))}}
                                            ...
                                            <section id="no-more-tables" >
                                              <table class="table table-bordered table-striped table-condensed cf" style="text-align:center;">
                                                  <tbody class="cf">
                                                      ...
                                                      <tr>
                                                        <th>Location:</th><td>{{ Form::text('locationNew','', array('class' => 'form-control', 'id' => 'locationNew')) }}</td>
                                                      </tr>
                                                       <tr>
                                                        <th>Type of Sale:</th><td>{{ Form::select('saleTypeNew',array(''=>'SaleType','PMcontract'=>'PM contract','Rental'=>'Rental','ServiceQuote'=>'Service Quote','Electrical'=>'Electrical','Generators'=>'Generators','Shop'=>'Shop','Permits'=>'Permits','OtherDesc'=>'Other: Desc','Grassivy'=>'Grassivy','Special_Project'=>'Special Project'),'', array('class' => 'form-control', 'id' => 'saleTypeNew')) }}</td>
                                                      </tr>
                                                       <tr>
                                                        <th>Quote/Opportunity Name:</th><td>{{ Form::text('opNameNew','', array('class' => 'form-control', 'id' => 'opNameNew')) }}</td>
                                                      </tr>
                                                      <tr>
                                                        <th>Projected Sale Price:</th><td>{{ Form::text('pSaleNew','', array('class' => 'form-control', 'id' => 'pSaleNew')) }}</td>
                                                      </tr>
                                                       <tr>
                                                      ...
                                                      <tr>
                                                        <th>Labor Costs:</th><td>{{ Form::text('laborCostNew','', array('class' => 'form-control', 'id' => 'laborCostNew')) }}</td>
                                                      </tr>
                                                      <tr>
                                                        <th>Material Costs:</th><td>{{ Form::text('matCostNew','', array('class' => 'form-control', 'id' => 'matCostNew')) }}</td>
                                                      </tr>
                                                      </tr>
                                                      <tr>
                                                        <th>Expected Date to close sale:</th><td>{{ Form::text('closeDateNew','', array('class' => 'form-control  form-control-inline input-medium default-date-picker', 'id' => 'closeDateNew')) }}</td>
                                                      </tr>
                                                      <tr>
