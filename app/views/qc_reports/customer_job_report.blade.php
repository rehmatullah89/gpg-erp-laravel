...
@section('dashboard_panels')
          ...
          <div class="row">
                            ...
                            <tbody>
                              <tr>
                                  <td data-title="Start Date:" style="width:12.5%;">
                                    {{Form::label('InvoiceSDate', 'Start Date:', array('class' => 'control-label', 'style'=>'white-space:nowrap; font-weight: bold;'))}} 
                                  ...
                                  <td data-title="End Date:" style="width:12.5%;">
                                    {{Form::label('InvoiceEDate', 'End Date:', array('class' => 'control-label', 'style'=>'white-space:nowrap; font-weight: bold;'))}} 
                                  ...
                                  <td data-title="Job Status:" style="width:12.5%;">
                                    {{Form::label('optJobStatus', 'Job Status:', array('class' => 'control-label', 'style'=>'white-space:nowrap; font-weight:bold;'))}} 
                                    {{ Form::select('optJobStatus',array(''=>'ALL','completed'=>'Have been Completed','notcompleted'=>'Jobs Not Completed'),'', array('class' => 'form-control', 'id' => 'optJobStatus')) }}
                                  </td>
                                  <td data-title="Report View:" style="width:12.5%;">
                                    {{Form::label('view', 'Report View:', array('class' => 'control-label', 'style'=>'white-space:nowrap; font-weight:bold;'))}} 
                                    {{ Form::select('view',array(''=>'-','expand'=>'Customer detail View','colapse'=>'Customer summary View','jobView'=>'Jobs View'),'expand', array('class' => 'form-control', 'id' => 'view')) }}
                                  </td>
                                  <td data-title="Job Type:" style="width:12.5%;">
                                  ...
                                  <td data-title="Contract Number:" style="width:12.5%;">
            ...
            @endif
              ...
              <br/>
              {{ HTML::link("qc_reports/excelCustomerJobRepExport?".http_build_query(array_filter(Input::except('_token', 'page'))), 'Export Excel' , array('class'=>'btn btn-success'))}}
            </section>
           </div>
        </div>      
      </div>
