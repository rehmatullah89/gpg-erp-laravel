             ...
             <span class="tools pull-right">
              ...
              <section class="panel">
                          <header class="panel-heading" style="background: white !important;  border-color: solid grey; color:grey;">
                              <i><b>SEARCH by:</b> Dates / Filter / Employee & Employee Type</i>
                          </header>
                             {{ Form::open(array('before' => 'csrf' ,'url'=>route('reports/gen_reportopt'), 'files'=>true, 'method' => 'post')) }}
                                  ...
                                  <td data-title="Job Time Start Date:">
                                   ...
                                   {{ Form::text('EDate','', array('class' => 'form-control form-control-inline input-medium default-date-picker', 'id' => 'EDate','required')) }}
                                    ...
                                    <td data-title="reportView:">
                                      {{Form::select('reportView',array(''=>'Detailed View','summary1'=>'Summary View [Workshop/LeaveHours]','summary2'=>'Summary View [All Together]','summary3'=>'Summary View Missing Hours [All Together]'),'', ['id' => 'reportView', 'class'=>'form-control m-bot15'])}}
                                    </td>
                                    <td data-title="employee:">
                                      {{Form::select('employee',$salesp_arr,'', ['id' => 'employee', 'class'=>'form-control m-bot15','multiple'])}}
                                    </td>
                                    <td data-title="employeetype:">
                                      {{Form::select('employeetype',array(''=>'Select Employee Type')+$emp_type,'', ['id' => 'employeetype', 'class'=>'form-control m-bot15','multiple'])}}
                                    </td>
                                    <td>
                                      {{Form::select('employee_in[]',array('0'=>'Included','1'=>'Excluded'),'', ['id' => 'employee_in', 'class'=>'form-control m-bot15','multiple'])}}
                                    </td>
                                    <td>
                ...
                <section id="no-more-tables">
                  ...
                  <table class="table table-bordered table-striped table-condensed cf" id="mytable1" align="center">
                   ...
                   {{ HTML::link("reports/excelGenRepExport?".http_build_query(array_filter(Input::except('_token', 'page'))), 'Export Excel' , array('class'=>'btn btn-success'))}}
                  <br/>
