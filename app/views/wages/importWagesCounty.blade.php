...
@section('dashboard_panels')
             ...
             <!-- ////////////////////////////////////////// -->
            {{ Form::open(array('before' => 'csrf' ,'url'=>route('wages/insertUpdateCounties'), 'files'=>true, 'method' => 'post')) }}
             ...
             <div class="adv-table">
              ...
              {{Form::submit("INSERT / UPDATE COUNTIES", array('class' => 'btn btn-success', 'id'=>'insert_update_counties'))}}
             </div>
              </div>
            {{ Form::close() }}
              </section>
