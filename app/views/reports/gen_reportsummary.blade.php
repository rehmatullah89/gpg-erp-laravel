             ...
             <span class="tools pull-right">
              ...
              <section class="panel">
                          <header class="panel-heading" style="background: white !important;  border-color: solid grey; color:grey;">
                             ...
                             {{ Form::open(array('before' => 'csrf' ,'url'=>route('reports/gen_reportsummary'), 'files'=>true, 'method' => 'post')) }}
                                  ...
                                  <td data-title="Job Time Start Date:">
                                   ...
                                   {{ Form::text('EDate','', array('class' => 'form-control form-control-inline input-medium default-date-picker', 'id' => 'EDate','required')) }}
                                    ...
                                    <td data-title="tech_flag:">
                                      <input type="checkbox" value="1" id="tech_flag" name="tech_flag">
                                      Highlight jobs having more than 1 techs
                                    </td>
              ...
              <section id="no-more-tables">
                  ...
                  <table class="table table-bordered table-striped table-condensed cf" id="mytable1" align="center">
                   ...
                   {{ HTML::link("reports/excelGenRepSummaryExport?".http_build_query(array_filter(Input::except('_token', 'page'))), 'Export Excel' , array('class'=>'btn btn-success'))}}
                  <br/>
