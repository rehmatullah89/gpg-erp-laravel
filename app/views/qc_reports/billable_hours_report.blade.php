      ...
      <!-- page start-->
                            ...
                            <tbody>
                              <tr>
                                  <td data-title="Start Date:" style="width:12.5%;">
                                    {{Form::label('SDate1', 'Start Date:', array('class' => 'control-label', 'style'=>'white-space:nowrap; font-weight: bold;'))}} 
                                    {{ Form::text('SDate1','', array('class' => 'form-control form-control-inline input-medium default-date-picker', 'id' => 'SDate1')) }}
                                  </td>
                                  <td data-title="End Date:" style="width:12.5%;">
                                    {{Form::label('EDate1', 'End Date:', array('class' => 'control-label', 'style'=>'white-space:nowrap; font-weight: bold;'))}} 
                                    {{ Form::text('EDate1','', array('class' => 'form-control form-control-inline input-medium default-date-picker', 'id' => 'EDate1')) }}
                                  </td>
                                  <td data-title="Employee Name:" style="width:12.5%;">
                                    {{Form::label('optEmployee', 'Employee Name:', array('class' => 'control-label', 'style'=>'white-space:nowrap; font-weight:bold;'))}} 
                                    {{ Form::select('optEmployee',array(''=>'ALL')+$emp_arr,'', array('class' => 'form-control', 'id' => 'optEmployee')) }}
                                  </td>
                                  <td data-title="Employee Type:" style="width:12.5%;">
                                    {{Form::label('empType', 'Employee Type:', array('class' => 'control-label', 'style'=>'white-space:nowrap; font-weight:bold;'))}} 
                                    {{ Form::select('empType',array(''=>'ALL')+$emp_types,'', array('class' => 'form-control', 'id' => 'empType')) }}
                                  </td>
                                  <td data-title="Order By:" style="width:12.5%;">
                                    {{Form::label('orderby', 'Order By:', array('class' => 'control-label', 'style'=>'white-space:nowrap; font-weight:bold;'))}} 
                                    {{ Form::select('orderby',array('ename'=>'Employee Name','etype'=>'Employee Type'),'ename', array('class' => 'form-control', 'id' => 'orderby')) }}
                                  </td>
                                  <td style="width:12.5%;">
        ...
        <div class="row">
              ...
              <section id="no-more-tables">
                ...
                {{ HTML::link("qc_reports/excelBillableHoursExport?".http_build_query(array_filter(Input::except('_token', 'page'))), 'Export Excel' , array('class'=>'btn btn-success'))}}
            <br/>
