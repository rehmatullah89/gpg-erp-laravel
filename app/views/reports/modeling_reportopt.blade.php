             ...
             <span class="tools pull-right">
              ...
              <section class="panel">
                          <header class="panel-heading" style="background: white !important;  border-color: solid grey; color:grey;">
                              <i><b>SEARCH by:</b> Year / Employee</i>
                          </header>
                             {{ Form::open(array('before' => 'csrf' ,'url'=>route('reports/modeling_reportopt'), 'files'=>true, 'method' => 'post')) }}
                                  <section id="no-more-tables" style="padding:10px;">
                                  <table class="table table-bordered table-striped table-condensed cf" id="mytable" align="center">
                                  <thead>
                                    <tr>
                                      <th><b>Select Year</b></th>
                                      <th><b>Filter</b></th>
                                      <th><b>Action</b></th>
                                    </tr>
                                  </thead>
                ...
                <section id="no-more-tables" style="padding:10px;">
                  ...
                  ?>
                  <span><b>Period Start Date:</b>{{$start}}</span>
                  <span style="margin-left:20px;"><b>Period End Date:</b>{{$end}}</span>
                  <table class="table table-bordered table-striped table-condensed cf" id="mytable" align="center">
                    <thead>
                      <tr>
                        <th>Name</th>
                  ...
                  ?>
                   ...
                   {{ HTML::link("reports/excelCompModelingExport?".http_build_query(array_filter(Input::except('_token', 'page'))), 'Export Excel' , array('class'=>'btn btn-success'))}}
                  <br/>
