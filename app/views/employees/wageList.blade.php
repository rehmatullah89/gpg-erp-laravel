...
@if (isset($errors) && ($errors->any()))
 ...
 {{ Form::open(array('before' => 'csrf' ,'action' => 'EmployeeController@employeeWageList', 'files'=>true, 'method' => 'post', 'id' => 'customer_filters_form')) }}
                            ...
                            <tbody>
                              <tr>
                                  ...
                                  <td data-title="Filter:">
                                    ...
                                    {{Form::select('Filter', array(''=>'Select Filter','emp_name' => 'Employee Name', 'emp_status' => 'Status'), null, ['id' => 'Filter', 'class'=>'form-control m-bot15'])}}
                                  </td>
                ...
                <table class="table table-bordered table-striped table-condensed cf" style="text-align:center;">
                    <thead class="cf">
                        ...
                        <tr>
                            ...
                            <th style="text-align:center;">Rate/Salary</th>
                ...
                foreach($query_data as $data){ ?>
                    ...
                    <?php 
                     ...
                     <tr>
                        ...
                        <td data-title="Rate/Salary">&nbsp;
                            <?php echo $_DefaultCurrency.number_format($data['rate'],2);  ?><?php if ($data['cur']=='current' && $curFlag==0)  echo "&nbsp;<strong>[Current]</strong>" ?></td>
                        <td data-title="Start Date">&nbsp;
                            <?php  if (!empty($data['start_date'])) echo date("m/d/Y",strtotime($data['start_date'])); 
                                ?></td>
                        <td align="center"><?php  if ($data['type']=='h') echo "Hourly"; else echo "Salary";   ?></td>
                        <td align="center" nowrap="nowrap">
                            <a href="{{URL::route('employees/deleteWageRate', array('id'=>$data['id']))}}" onclick="javascript:return(confirm('Are you source, you want to DELETE this Wage Rate/Salary?'))">Delete</a>
                        </td>
                    </tr>
