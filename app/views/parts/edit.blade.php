...
@section('dashboard_panels')
             ...
             <!-- ////////////////////////////////////////// -->
              {{ Form::open(array('before' => 'csrf' ,'url'=>route('parts.update',array('id'=>$data[0]->id)), 'files'=>true, 'method' => 'put')) }}
              ...
              <section id="no-more-tables" >
                  <table class="table table-bordered table-striped table-condensed cf" style="text-align:center;">
                        <tbody>
                          ...
                          <td>{{ Form::select('_gpg_field_material_type_id',array(''=>'Select Type')+$type_arr,$data[0]->gpg_field_material_type_id, array('class' => 'form-control dpd1', 'id' => '_gpg_field_material_type_id', 'required')) }}</td>
                          </tr>
                          <tr>
                            <th style="text-align:center;">Description:*</th>
                            <td>{{ Form::text('_description',$data[0]->description, array('class' => 'form-control dpd1', 'id' => '_description', 'required')) }}</td>
                          </tr> 
                          <tr>
                          ...
                          <tr>
                            ...
                            <td>{{ Form::checkbox('_fixed_price', 1,$data[0]->fixed_price, ['class' => 'form-control']) }}</td>
                          </tr>
                      </tbody>
                  </table>
