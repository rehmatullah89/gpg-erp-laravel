...
@section('dashboard_panels')
              ...
              <header class="panel-heading">
                ADD NEW ASSET EQUIPMENT TYPE
              </header>
              <!-- \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\ -->
              <section class="panel">
                       <header class="panel-heading" style="background: white !important;  border-color: solid grey; color:grey;">
                              <b><i>Fill required* Inoformation to Add Eqp. Type! </i></b>
                          </header>
             ...
             <!-- ////////////////////////////////////////// -->
             {{ Form::open(array('before' => 'csrf' ,'url'=>route('asset/add_asset_equipment_type'), 'id'=>'frmid1', 'files'=>true, 'method' => 'post')) }}
