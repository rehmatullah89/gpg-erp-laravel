...
@section('dashboard_panels')
 <!-- page start-->
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          <header class="panel-heading">
                              BULK JOB DUE AMOUNT (AR) UPLOADER
                          </header>
  ...
  {{ Form::open(array('before' => 'csrf','id'=>'default','class'=>'form-horizontal' ,'url'=>route('job/job_due_amt_imp_opt_ar'), 'files'=>true, 'method' => 'post')) }}
