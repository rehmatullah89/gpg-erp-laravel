...
@section('dashboard_panels')
 <!-- page start-->
  ...
  {{ Form::open(array('before' => 'csrf','id'=>'default','class'=>'form-horizontal' ,'url'=>route('expense/expense_amt_imp_opt'), 'files'=>true, 'method' => 'post')) }}
                                     ...
                                     <div class="form-group">
                                      ...
                                      <div class="controls col-md-9">
                                        ...
                                        <div class="controls col-md-3">
                                          <span><h3>Start Date:</h3><sub></sub><b>Note:</b> Enter Start Date in Expense File</span>
                                          {{ Form::text('SDate','', array('class' => 'form-control form-control-inline input-medium default-date-picker', 'id' => 'SDate')) }}
                                        </div>
                                        <div class="controls col-md-3">
                                          <span><h3>End Date:</h3><sub></sub><b>Note:</b> Enter Last Date in Expense File</span>
          ...
          $('#default').stepy({
              ...
              if (step == '0'){
                    if($('#uploadFile').val() == ""){
                      ...
                      conf = confirm('WARNNING: The Recods from given dates interval Will be Deleted from database!');
                      if(conf == false){
                        return false;
                      }else{
                         $('#default').submit();
