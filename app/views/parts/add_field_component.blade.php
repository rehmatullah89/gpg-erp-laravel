...
@section('dashboard_panels')
             ...
             <!-- ////////////////////////////////////////// -->
              {{ Form::open(array('before' => 'csrf' ,'url'=>route('parts/add_field_component'), 'files'=>true, 'method' => 'post')) }}
              ...
              <section id="no-more-tables" >
                  <table class="table table-bordered table-striped table-condensed cf" style="text-align:center;">
                        <tbody>
                          ...
                          <td>{{ Form::select('_gpg_field_component_type_id',array(''=>'Select Type')+$type_arr,'', array('class' => 'form-control dpd1', 'id' => '_gpg_field_component_type_id', 'required')) }}</td>
                          </tr>
                          <tr>
