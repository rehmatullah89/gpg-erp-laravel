             ...
             <span class="tools pull-right">
              ...
              <section class="panel">
                          <header class="panel-heading" style="background: white !important;  border-color: solid grey; color:grey;">
                             ...
                             {{ Form::open(array('before' => 'csrf' ,'url'=>route('qc_reports/service_job_check'), 'files'=>true, 'method' => 'post')) }}
                                  ...
                                  <table class="table table-bordered table-striped table-condensed cf" id="mytable" align="center">
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        {{Form::text('jobnumber','', ['id' => 'jobnumber', 'class'=>'form-control m-bot15'])}}
                                      </td>
                                      <td>
              ...
              {{ HTML::link("qc_reports/excelDupServJobExport?".http_build_query(array_filter(Input::except('_token', 'page'))), 'Export Excel' , array('class'=>'btn btn-success'))}}
              <br/>
