          ...
          <div class="row">
             ...
             <span class="tools pull-right">
              ...
              <section class="panel">
                <header class="panel-heading" style="background: white !important;  border-color: solid grey; color:grey;">
                  <b>Search By:<i> Schedule Date</i></b>
                </header>
                              ...
                              <tr>
                                  <?php
                                   ...
                                   <td data-title="Date Start:">
                                    {{Form::label('SDate2', 'Date Start:', array('class' => 'control-label', 'style'=>'white-space:nowrap; font-weight: bold;'))}} 
                                   ...
                                   <td data-title="Date End:">
                                    {{Form::label('EDate2', 'Date End:', array('class' => 'control-label', 'style'=>'white-space:nowrap; font-weight: bold;'))}} 
                                    {{ Form::text('EDate2','', array('class' => 'form-control form-control-inline input-medium default-date-picker', 'id' => 'EDate2')) }}
                                   </td>
                                   <td colspan="2" bgcolor="#FFFFFF">
                                     <input type="checkbox" name="ignoreCostDate" id="ignoreCostDate" value="1" <?php echo ($ignoreCostDate==1)?'checked="checked"':'' ?>  />
                                                  Ignore Date stamp  on Material Cost and Labor Cost.<br /><input type="checkbox" name="ignoreInvoiceDate" id="ignoreInvoiceDate" value="1" <?php echo ($ignoreInvoiceDate==1)?'checked="checked"':'' ?>  />
                                   ...
                                   <td colspan="2" bgcolor="#FFFFFF">
                                    <?php 
                                      ...
                                      ?>  
                                        <input type="checkbox" name="<?php echo $key; ?>" id="<?php echo $key; ?>" <?php if (isset($checks[$key]) && $checks[$key]==1) { ?>checked="checked" <?php } ?> value="1"/><?php echo $value; ?>&nbsp;&nbsp;&nbsp;&nbsp;
                                      <?php } ?>
            ...
            <div class="row">
             <div class="col-sm-12">
              ...
              <b>Search For Report With check boxes</b>
              <?php if (isset($_REQUEST['__gen'])) { 
              ...
              {{ HTML::link("reports/serviceJobMultipleExport?".http_build_query(array_filter(Input::except('_token', 'page'))), 'Export Excel' , array('class'=>'btn btn-success'))}}
              <?php }
