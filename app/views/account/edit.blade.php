...
@section('dashboard_panels')
             ...
             <!-- ////////////////////////////////////////// -->
             {{ Form::open(array('before' => 'csrf' ,'url'=>route('account.update',array('id'=>$id)), 'id'=>'frmid1', 'files'=>true, 'method' => 'put')) }}
              <?php 
                $mCount = 0;
              ?>
                      ...
                      <TABLE class="table table-bordered table-striped table-condensed cf" style="text-align:center;">
                        <TBODY>
                          <TR>
                            ...
                            <TD width="74%" >
                              <div align="left">
                              <INPUT name="uname" class="form-control" id="uname" value="<?php  echo $employee_info[0]->uname; ?>" required>
                              <INPUT type="hidden" name="p_uname" class="form-control" id="p_uname" value="<?php  echo $employee_info[0]->uname; ?>">
                              e.g. john</div></TD>
                          </TR>
                          <tr>
                          ...
                          <tr>
                            ...
                            <?php  $modQuery = DB::select(DB::raw("select a.id mod_id, a.module_name, b.GPG_module_id from gpg_module a left join gpg_mod_perm b on (a.id = b.GPG_module_id and b.GPG_ad_acc_id = '$id') where a.parent = 0")); 
                              foreach ($modQuery as $key => $value1) {
                              $modRow = (array)$value1;
                              if (++$mCount%2) { echo "</tr><tr>"; }
                              ?>
                              <td width="1" align="left" valign="top" bgcolor="#FFFFFF"><input type="checkbox" <?php echo ($modRow['GPG_module_id']!=""?"checked=\"checked\"":""); ?> value="<?php  echo $modRow['mod_id'] ?>" id="modPerm_<?php  echo $mCount ?>" name="modPerm[]" onclick="javascript:ModCheckAllSub(<?php  echo $mCount ?>);" onchange="javascript:ModCheckAllSub(<?php  echo $mCount ?>);"/></td>
                              <td width="50%" align="left" valign="top" bgcolor="#FFFFFF">&nbsp;<?php  echo $modRow['module_name']; 
                              $modSubQuery = DB::select(DB::raw("select a.id mod_id, a.module_name, b.GPG_module_id from gpg_module a left join gpg_mod_perm b on (a.id = b.GPG_module_id and b.GPG_ad_acc_id = '$id') where a.parent = '".$modRow['mod_id']."'"));  
                              $mmCount = 0;
                              foreach ($modSubQuery as $key => $value2) {
                                $modSubRow = (array)$value2;
                                ++$mmCount;
                              ?><br><input type="checkbox" value="<?php  echo $modSubRow['mod_id'] ?>" <?php echo ($modSubRow['GPG_module_id']!=""?"checked=\"checked\"":""); ?> id="modSubPerm_<?php  echo $mCount ?>_<?php  echo $mmCount ?>" name="modPerm[]"/>&nbsp;<?php  echo $modSubRow['module_name']; 
                              $modSubSubQuery = DB::select(DB::raw("select a.id mod_id, a.module_name, b.GPG_module_id from gpg_module a left join gpg_mod_perm b on (a.id = b.GPG_module_id and b.GPG_ad_acc_id = '$id') where a.parent = '".$modSubRow['mod_id']."'"));  
                              foreach ($modSubSubQuery as $key => $value3) {
                                $modSubSubRow = (array)$value3;
                                ++$mmCount;
                              ?><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" <?php echo ($modSubSubRow['GPG_module_id']!=""?"checked=\"checked\"":""); ?> value="<?php  echo $modSubSubRow['mod_id'] ?>" id="modSubPerm_<?php  echo $mCount ?>_<?php  echo $mmCount ?>" name="modPerm[]"/>&nbsp;<?php  echo $modSubSubRow['module_name']; 
                              }
                            } ?></td><?php  
                          } ?>
                  ...
                  <TD width="74%"><div align="left" style="border:1px solid #eee;">
                    <table class="table table-bordered table-striped table-condensed cf" style="text-align:center;">
                      ...
                      <?php
                        ...
                        ?>
                      <td id="emp_check">
                        <input type="checkbox" name="allow_emps[]" <?php echo in_array($emp_row['id'],$allowed_emps)? "checked=\"checked\"" : "" ?> value="<?php echo $emp_row['id']?>" id="allowed_emp_<?php echo $emp_row['id'];?>" /><?php echo $emp_row['name']; ?>
                      </td>
                      <?php }?>
                    </tr>
                  </table>
              ...
              <TR>
                ...
                <TD width="74%">
                  <div align="left">
                  <INPUT name="fname" class="form-control" id="fname" value="<?php  echo $employee_info[0]->fname; ?>">      
                </div></TD>
              </TR>
              <TR>
                ...
                <TD width="74%">
                  <div align="left">
                  <INPUT name="lname" class="form-control" id="lname" value="<?php  echo $employee_info[0]->lname; ?>">      
                  </div></TD>
              </TR>
              <TR>
                ...
                <TD width="74%">
                  <div align="left">
                  <INPUT name="email" class="form-control" id="email" value="<?php  echo $employee_info[0]->email; ?>" size="35" required>
              ...
              <TR>
                ...
                <TD width="74%">
                <div align="left">
                  {{Form::select('country',$countries,$employee_info[0]->country_id, ['id' => 'country', 'class'=>'form-control m-bot15'])}}
                </div></TD>
              </TR>
              <TR>
                ...
                <TD width="74%">
                  <div align="left">
                  <INPUT name="phone" class="form-control" id="phone" value="<?php  echo $employee_info[0]->phone; ?>"> 
                  </div></TD>
              </TR>
              <TR>
              ...
              <TR>
                ...
                <INPUT type="submit" class="btn btn-success" value="Update Account" name="Submit">
                </DIV></TD>
              </TR>    
            </TBODY>
          </TABLE>
